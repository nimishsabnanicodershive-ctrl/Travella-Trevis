...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      {currentPage === 'login' ? (
        <LoginPage onBack={navigateTo('home')} onLoginSuccess={handleLoginSuccess} />
      ) : (
        <>
          ...
          {currentPage === 'blueprint' && <BlueprintPage />}
          {currentPage === 'architecture' && <ArchitectureManifest />}
          {currentPage === 'platform-blueprint' && <ProjectBlueprint />}
